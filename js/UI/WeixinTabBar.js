...
class WeixinTabBar extends Component {
    ...
    renderTabOption(tab, i) {
        ...
        return (
            <TouchableOpacity activeOpacity={1} key={i} onPress={() => this.props.goToPage(i)} style={tabStyle}
                              opacity="0">
    ...
    render() {
        return (
            <View style={styles.main}>
                <TouchableOpacity activeOpacity={1} style={styles.leftTitle} onPress={() => {
                ...
                <TouchableOpacity activeOpacity={1} style={styles.rightTitle} onPress={() => {
